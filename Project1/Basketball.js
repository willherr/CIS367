...
class Basketball {
	...
	constructor (gl) {
		...
		let orange1 = vec3.fromValues(255/255, 140/255, 0/255);
		let orange2 = vec3.fromValues(255/255, 165/255, 0/255);

		this.ball = new RecursiveSphere(gl, .1, 5, orange1, orange2);
