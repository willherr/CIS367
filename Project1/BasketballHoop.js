...
class BasketballHoop {
    constructor (gl) {
        ...
        let moveOver = vec3.fromValues (-0.05, 0.08, -0.3);
        ...
        let moveBB = vec3.fromValues (0.13, 0.12, 0.28);
