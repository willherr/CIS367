/**
 * Created by Hans Dulimarta on 2/4/17.
 */
class Axes {
	constructor (gl) {
		...
		this.xaxis = new Cylinder(gl, 0.02, 0.02, 1, 20, xcolor, xcolor);
		this.yaxis = new Cylinder(gl, 0.02, 0.02, 1, 20, ycolor, ycolor);
		this.zaxis = new Cylinder(gl, 0.02, 0.02, 1, 20, zcolor, zcolor);
		...
		let transx = vec3.fromValues(0.5, 0, 0);
		let transy = vec3.fromValues(0, 0.5, 0);
		let transz = vec3.fromValues(0, 0, 0.5);
