...
class Axes {
    constructor (gl) {
        ...
        this.xaxis = new Cylinder(gl, 0.03, 0.03, 0.9, 20, xcolor, xcolor);
        this.yaxis = new Cylinder(gl, 0.03, 0.03, 0.9, 20, ycolor, ycolor);
        this.zaxis = new Cylinder(gl, 0.03, 0.03, 0.9, 20, zcolor, zcolor);
